    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        body::before {
            ...
            animation: orbOrbitA 20s linear infinite;
        ...
        body::after {
            ...
            animation: orbOrbitB 24s linear infinite;
            will-change: transform;
        }

        @keyframes orbOrbitA {
            0% { transform: translate3d(0, 0, 0) scale(1); }
            25% { transform: translate3d(calc(-100vw + 220px), 16vh, 0) scale(1.05); }
            50% { transform: translate3d(calc(-100vw + 240px), calc(100vh - 220px), 0) scale(1); }
            75% { transform: translate3d(8vw, calc(100vh - 240px), 0) scale(1.06); }
            100% { transform: translate3d(0, 0, 0) scale(1); }
        }

        @keyframes orbOrbitB {
            0% { transform: translate3d(0, 0, 0) scale(1); }
            25% { transform: translate3d(calc(100vw - 280px), -18vh, 0) scale(1.04); }
            50% { transform: translate3d(calc(100vw - 260px), calc(-100vh + 280px), 0) scale(1); }
            75% { transform: translate3d(-10vw, calc(-100vh + 260px), 0) scale(1.05); }
            100% { transform: translate3d(0, 0, 0) scale(1); }
        }
            ...
            <div class="grid">
                ...
                <div class="form-group full">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="email" name="email" class="form-input" placeholder="email@siswa.com" value="{{ old('email') }}" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="text" name="nis" class="form-input" placeholder="Nomor Induk Siswa" value="{{ old('nis') }}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="text" name="no_hp" class="form-input" placeholder="08xxxxxxxxxx" value="{{ old('no_hp') }}">
                    </div>
                </div>
                ...
                <div class="form-group full">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="text" name="alamat" class="form-input" placeholder="Alamat domisili" value="{{ old('alamat') }}">
                    </div>
                </div>
