...
<?php $__env->startSection('page-subtitle','Jadwal mengajar mingguan kamu'); ?>
...
<div style="display:flex;flex-direction:column;gap:16px;">
    ...
    <div class="card" style="border-left:4px solid var(--pink-500);">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:14px;">
            <div style="width:32px;height:32px;border-radius:8px;background:linear-gradient(135deg,var(--pink-400),var(--pink-600));color:white;display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:800;"><?php echo e(strtoupper(substr($hari,0,3))); ?></div>
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
            ...
            <div style="display:flex;align-items:center;gap:14px;padding:12px 14px;background:var(--pink-50);border-radius:10px;">
                ...
                <?php if($j->ruangan): ?><span class="badge badge-gray"><?php echo e($j->ruangan); ?></span><?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\smatrack\resources\views/guru/jadwal.blade.php ENDPATH**/ ?>