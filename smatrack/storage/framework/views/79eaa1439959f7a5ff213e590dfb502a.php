...
<div class="wrapper">
    ...
    <div class="login-box">
        <h2>Masuk ke Akun</h2>
        <div class="subtitle">Gunakan email dan password yang diberikan admin</div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="email" name="email" class="form-input"
                        placeholder="email@smatrack.com"
    ...
    <div class="demo-box">
        ...
        <div class="demo-cards">
            ...
            <div class="demo-card" onclick="fillLogin('dimas@siswa.com')">
                <div class="icon">🎓</div>
                <div class="label">Siswa XII</div>
                <div class="email">dimas@siswa.com</div>
            </div>
        </div>
    </div>
...
</html><?php /**PATH D:\smatrack\smatrack\resources\views/auth/login.blade.php ENDPATH**/ ?>